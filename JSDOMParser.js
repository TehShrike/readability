...
(function(global) {
  ...
  function encodeTextContentHTML(s) {
    return s.replace(/[&<>]/g, x => reverseEntityTable[x]);
  }
  ...
  function decodeHTML(str) {
    return str.replace(/&(quot|amp|apos|lt|gt);/g, (match, tag) => entityTable[tag]).replace(/&#(?:x([0-9a-z]{1,4})|([0-9]{1,4}));/gi, (match, hex, numStr) => {
